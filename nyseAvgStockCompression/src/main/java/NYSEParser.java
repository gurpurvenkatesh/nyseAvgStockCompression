...
public class NYSEParser {
	...
	public Long getTradeDateNumeric(){
		...
		SimpleDateFormat originalTradeDateFormat = new SimpleDateFormat("dd-MMM-yy");
		SimpleDateFormat TargetTradeMonthFormat = new SimpleDateFormat("yyyyMMdd");
		Date originalDate = new Date();
		...
		Long targetTradeNumeric = new Long(TargetTradeMonthFormat.format(originalDate));
		
		return targetTradeNumeric;
	}
